# Projeto pedidos
## Exemplo de agregação de pedidos
![diagrama](./pedidos_n_para_n.png)
## Ambiente
- VsCode
- NodeJS
- MySQL
...
## Exemplo de agregação de pedidos N para N com produtos
```sql
...
module.exports = { read };
```
Resultado depois do BackEnd rodar:
```json
[
	{
		"id": 1,
		"data": "2024-11-25T14:01:27.000Z",
		"total": 100,
		"produtos": [
			{
				"id": 1,
